  ...
  const handleOpenDropdown = () => {
    if (buttonRef.current) {
      ...
      buttonRef.current.measureInWindow(
        (windowX: number, windowY: number, width: number, height: number) => {
  ...
  return (
    <>
      ...
      <Pressable ref={buttonRef} onPress={handleOpenDropdown}>
        <AutoLayout axis="horizontal" align="center" gap={4}>
              ...
              >
                <AutoLayout
                  ...
                  bg={
                    selectedValue === option.value
                      ? theme.optionBackgroundSelected
                      : 'transparent'
                  }
                  style={{
                ...
                >
                  <BaseText
                    ...
                    color={
                      selectedValue === option.value
                        ? theme.optionTextSelected
                        : theme.optionTextUnselected
                    }
                    numberOfLines={1}
                  >
                    {option.label}
